...
export declare class Looker40SDK extends APIMethods implements ILooker40SDK {
    ...
    jdbc_interface(avatica_request?: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<IJdbcInterface, IError>>;
    ...
    run_sql_interface_query(query_id: number, result_format: string, options?: Partial<ITransportSettings>): Promise<SDKResponse<string, IError | IValidationError>>;
